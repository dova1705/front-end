...
export default function Sandwich(): JSX.Element {
    ...
    function handleAddCheese(): void {
        dispatch({ type: 'sandwich/addIngredient', payload: 'cheese' }); // в файле Action добавлено 
    }
    ...
    function handleClear(): void {
        dispatch({ type: 'sandwich/clear' }); // в файле Action добавлено. payload - пустая строка
    }
  return (
    <div>
